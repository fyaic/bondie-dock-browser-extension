...
2. 推进 `bondie-control-plane`：初始 dev token / registry / relationship resolver / bridge proxy 骨架已创建；下一步补 health aggregation、真实 OAuth token provider 和 Bondie Dock runtime adapter。
